...
let scene_, threejs_, camera_, shaders_, totalTime_, previousRAF_
  ...
  function Initialize_() {
    ...
    document.body.appendChild(threejs_.domElement);
  ...
  function Step_(timeElapsed) {
    ...
    for (let s of shaders_) {
      s.uniforms.fogTime.value = totalTime_;
    }
  }
  ...
  function Fog(){
    ...
    scene_.fog = new THREE.FogExp2(0xDFE9F3, 0.0000005);
  }
// }
